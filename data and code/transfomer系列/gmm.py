...
ax.set_ylabel('Humidity (%)', labelpad=12)
ax.set_zlabel('Wind Speed 50m (m/s)', labelpad=12)
ax.view_init(elev=25, azim=45)  # 调整观察角度

# 添加颜色条和图例
cbar = plt.colorbar(scatter, pad=0.15)
cbar.set_label('Weather Cluster')
plt.title('3D Weather Clustering (Temp-Humi-Wind)', y=1.02, fontsize=14)
...
plt.title('PCA Projection of 3D Weather Features', pad=15)
